...
public class ScannerActivity extends AppCompatActivity {
    ...
    private DatabaseReference asistentes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asistentes=db.getReference(auth.getCurrentUser().getUid());
        ...
        cameraPreview.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    //Request permission
                    ActivityCompat.requestPermissions(ScannerActivity.this, new String[] {Manifest.permission.CAMERA},RequestCameraPermisionID);
                    return;
                }
                            ...
                            new Thread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if(user!=null){
                                        ...
                                        asistentes.child("Asistentes").child(user.getName()).setValue(1);
